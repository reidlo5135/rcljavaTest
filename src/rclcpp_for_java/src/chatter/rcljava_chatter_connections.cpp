...
JNIEXPORT void JNICALL Java_net_robot_wavem_publisher_chatter_ChatterPublisher_publish_1to_1chatter(JNIEnv * j_env, jobject j_obj, jobjectArray j_chatter_message_array) {
    ...
    rclcpp::Publisher<std_msgs::msg::String>::SharedPtr ros_chatter_publisher = node->create_publisher<std_msgs::msg::String>(DEFAULT_TOPIC_NAME, rclcpp::QoS(rclcpp::KeepLast(DEFAULT_QOS)));
